...
<table class="cours-planC">
  ...
  <tbody>
    ...
    <tr>
      <td>TP 01</td>
      <td><a href="Correction exercice TP1">Correction exo</a></td>
      <td>Lecture de fichier en C++, création et parcours d'un vecteur. Utilisation du type string et premiers pas.</td>
    </tr>
  </tbody>
</table>
</div>
